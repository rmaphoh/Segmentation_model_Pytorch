...
def arch_select(model_structure,input_channels,n_classes):

    if model_structure == 'unet':
        model_fl = UNet(input_channels,n_classes,bilinear=False)

    return model_fl


class UNet(nn.Module):
    def __init__(self, input_channels, n_classes, bilinear):
